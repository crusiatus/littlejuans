...
export default function App() {
  ...
  const [songs, setSongs] = useState([
    { id: 4, title: 'Go Up', source: require('../assets/sb19_music/goup.mp3'), image: require('../assets/sb193.jpg') },
    { id: 5, title: 'Alab', source: require('../assets/sb19_music/alab.mp3'), image: require('../assets/sb194.jpg') },
  ]);
  ...
  async function playSound(index) {
    try {
      ...
      const { sound: newSound } = await Audio.Sound.createAsync(song.source, { shouldPlay: true });
      setSound(newSound);
      setIsPlaying(true);
  ...
  const renderItem = ({ item, index }) => (
    <TouchableOpacity onPress={() => playSound(index)} style={styles.queueItem}>
